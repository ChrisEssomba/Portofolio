          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Salut! Je suis Chris, votre futur `} <span className="txt-rotate" data-dataPeriod="1000" data-rotate='[ "Data Scientist", "Data Analyst", "Data Engineer" ]'><span className="wrap">{text}</span></span></h1>
